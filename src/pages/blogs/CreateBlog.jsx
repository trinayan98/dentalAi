  ...
  const startGeneration = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        targetAudience: options.targetAudience || "public",
      };

      // Make API call to generate content
      const response = await fetch(
        "https://n8n.apisdor.com/webhook/f4c49fca-1848-4d44-b6b5-73c139352c7c",
        {
          method: "POST",
          headers: {
      ...
      setContent(data.output); // Set the generated content
      // Update title only if API returns a blog_title
