      ...
      <div className="grid grid-cols-8 gap-6 ">
        ...
        <div className=" col-span-5 ">
          <div className="grid grid-cols-3 gap-6 mb-2">
            ...
            />
            <Input label="Provider" className="bg-gray-50 border-0 " />
          ...
          <div className="grid grid-cols-6">
            <div
              className={`text-sm font-bold rounded-md p-2 flex items-center justify-between ${
            ...
            {!isTemplateMinimized && (
              <div className="text-sm font-bold rounded-md p-2 col-span-2">
                Template
              </div>
            )}
          </div>
          <div className="grid grid-cols-6 gap-0 rounded-md border border-2 border-gray-300 min-h-[56vh]  max-h-[60vh] bg-white p-0 overflow-y-auto">
            <div
              className={` p-5 ${
                isTemplateMinimized ? "col-span-6" : "col-span-4"
              } relative`}
            >
              <div className="flex items-center justify-end mb-2 relative py-2">
                {summaryData && !summaryLoading && (
                  <div className="flex items-center gap-2 justify-end w-full pe-1">
                    {isEditingSummary ? (
                      <>
                        <button
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 text-xs text-gray-600 hover:text-gray-800 font-medium px-2 py-1 bg-gray-100 rounded-sm"
                        >
                          <X size={14} />
                          Cancel
                        </button>
                      ...
                      <>
                        <button
                          ...
                          className="flex items-center gap-1 text-xs text-blue-600 hover:text-blue-800 font-medium    px-2 py-1 bg-gray-100 rounded-sm"
                        >
                          <Edit size={14} color="blue" />
                          Edit
                        </button>
                        <button
                          onClick={handleClearClick}
                          className="flex items-center gap-1 text-xs text-red-600 hover:text-red-800 font-medium   px-2 py-1 bg-gray-100 rounded-sm"
                          title="Clear saved summary"
                        >
                          <Trash size={14} />
                          Clear
                        </button>
                ...
                {!isTemplateMinimized && (
                  <button
                    ...
                    className="flex items-center justify-center w-6 h-6 rounded-full bg-green-200 hover:bg-gray-300 transition-colors absolute right-[-34px] top-2 z-10"
                    title="Minimize template"
                  >
                    <ChevronRight
                    ...
                    <div className="flex items-center justify-between">
                      <span>
                        ...
                        <span className="font-medium">
                          {summaryData.templateName || "Unknown"}
                        </span>
                      </span>
                      <span>
                        Saved:{" "}
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {isEditingSummary && (
                          <div className="flex items-center gap-2">
                            <button
                              onClick={() =>
                                handleSummarySectionChange(key, section.content)
                              }
            ...
            {!isTemplateMinimized && (
              <div className=" p-4  col-span-2 border-l-2 border-gray-300 relative">
                {selectedTemplate ? (
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      {/* <Edit className="h-3 w-3 text-green-500 cursor-pointer" /> */}
                    </div>
                    <div className="space-y-1 pl-4">
                      {getSortedFields(selectedTemplate).map((field, index) => (
                        <div
                          key={field.key}
          ...
          <div className="buttons flex items-center gap-4 mt-6">
            ...
            <button
              ...
              className="flex items-center gap-2 border border-primary-100 text-primary-500 bg-transparent rounded-full px-6 py-2 font-medium transition hover:bg-primary-50 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
              type="button"
            >
              {summaryLoading ? (
            ...
            {/* Copy Button */}
            <button
              className="flex items-center gap-2 border border-primary-100 text-primary-500 bg-transparent rounded-full px-6 py-2 font-medium transition hover:bg-primary-50 focus:outline-none"
              type="button"
            >
              <Copy size={18} />
              Copy
            ...
            {/* Print Button */}
            <button
              className="flex items-center justify-center border border-primary-100 text-primary-500 bg-transparent rounded-full p-2 transition hover:bg-primary-50 focus:outline-none"
              type="button"
            >
              <Printer size={18} />
            </button>
            ...
            {/* Delete Button */}
            <button
              className="flex items-center justify-center border border-gray-300 text-gray-400 bg-transparent rounded-full p-2 transition hover:bg-gray-100 focus:outline-none"
              type="button"
            >
              <Trash size={18} />
            </button>
